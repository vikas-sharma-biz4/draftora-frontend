...
describe("DynamicPipeline - Progressive Navigation", () => {
  ...
  describe("Step 1 (Parameters Page)", () => {
    ...
    it("should allow clicking Step 1 (current step)", () => {
      render(
        <DynamicPipeline currentStage="wizard_in_progress" completedSteps={[]} visible={true} />
      );
  ...
  describe("Step 2 (Review Page)", () => {
    ...
    it("should allow clicking Step 1 (previous step)", () => {
      render(
        <DynamicPipeline currentStage="parameters_complete" completedSteps={[1]} visible={true} />
      );
  ...
  describe("Step 3 (Web View Page)", () => {
    ...
    it("should allow clicking Step 1 (previous step)", () => {
      ...
      fireEvent.click(step1);
      expect(mockPush).toHaveBeenCalledWith("/parameters?proposalId=123");
    });
    ...
    it("should allow clicking Step 2 (previous step)", () => {
      ...
      fireEvent.click(step2);
      expect(mockPush).toHaveBeenCalledWith("/review?proposalId=123");
    });
  ...
  describe("Accessibility", () => {
    ...
    it("should have descriptive aria-labels", () => {
      // Use review pathname so Parameters shows as Completed, Review as Current
      mockPathname.mockReturnValue("/review");
      render(
        <DynamicPipeline currentStage="parameters_complete" completedSteps={[1]} visible={true} />
      );

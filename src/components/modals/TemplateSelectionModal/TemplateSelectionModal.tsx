...
import { getDocumentViewUrl, type ClientWithDocuments } from "@/services/client.service";
import {
  PROPOSAL_TEMPLATES,
...
export default function TemplateSelectionModal({
  ...
  async function handleViewDocument(
    ...
    try {
      ...
      // silently ignore — toast would interrupt the selection flow
    } finally {
                    ...
                    {PROPOSAL_TEMPLATES.map((template) => (
                      ...
                      >
                        ...
                        <div className={styles.templateCardInfo}>
                          ...
                          <div className={styles.templateCardDescription}>
              ...
              {selectedClient && (
                <div className={styles.section}>
                  ...
                  <div className={styles.uploadSection}>
                    ...
                    <p className={styles.hint}>
                      Upload new documents that will be parsed automatically
                    </p>
                        ...
                        {uploadedFiles.map(({ file, id, status, error, parsedData }) => (
                          <div key={id} className={styles.uploadedFileItem}>
                            ...
                            <button
                              ...
                              onClick={() => handleRemoveFile(id)}
                              title={
                                status === "parsing" ? "Cancel parsing and remove" : "Remove file"
                              }
                              aria-label="Remove file"
                            >
                              <X size={16} />

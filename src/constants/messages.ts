...
export const MESSAGES = {
  ...
  PROPOSAL_SECTION_ADDED: (name: string): string =>
    `"${name}" section added with AI-generated content!`,
  ...
  ARTIFACT_GENERATED: "Artifact generated successfully",
  ARTIFACT_GENERATE_FAILED: "Failed to generate artifact. Please try again.",
  ARTIFACT_SAVED: "Draft saved",
  ARTIFACT_SAVE_FAILED: "Failed to save draft.",

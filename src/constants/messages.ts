...
export const MESSAGES = {
  ...
  PROPOSAL_PDF_DOWNLOAD_FAILED: "Failed to download proposal PDF",
  ...
  PROPOSAL_TEMPLATE_UPDATED: "Template updated",
  PROPOSAL_TEMPLATE_UPDATED_NAMED: (name: string): string => `Template updated to ${name}`,
  PROPOSAL_STATIC_SECTION_NOT_ALLOWED: "Not allowed on static sections",
  PROPOSAL_CUSTOM_SECTION_ADDED: (name: string): string => `Section "${name}" added`,
  REVIEW_SECTION_REQUIRED: "Please select at least one section before generating the proposal",
  REVIEW_CLIENT_REQUIRED: "Please select a client before generating the proposal",
  HOURS_ESTIMATED: "Hours estimated successfully.",
  DOWNLOAD_COMING_SOON: "Download functionality coming soon",
  ...
  DRAFT_DELETE_FAILED: "Failed to delete draft.",
  DRAFT_ALL_DELETE_FAILED: "Failed to delete all drafts.",
  ...
  DRAFT_DOWNLOAD_NOT_READY: "Proposal is in progress — cannot be downloaded yet",

  ARTIFACT_GENERATED: "Artifact generated successfully",
  ARTIFACT_GENERATE_FAILED: "Failed to generate artifact. Please try again.",
  ARTIFACT_REGEN_FAILED: "AI regeneration failed. Please try again.",
  ...
  PARAMETERS_SECTION_REQUIRED: "Please add at least one section.",
  PARAMETERS_UPDATED: "Parameters updated. Review and regenerate to apply changes",
